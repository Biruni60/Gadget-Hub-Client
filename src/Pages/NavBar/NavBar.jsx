...
<button className="mr-4" onClick={()=>document.getElementById('my_modal_1').showModal()}>USER</button>
...
<label className="swap swap-rotate mt-2 mr-2">
    ...
    <ul className="flex gap-10 text-xl font-bold">
{
  ...
  <label className="swap swap-rotate mb-2 mr-2">
